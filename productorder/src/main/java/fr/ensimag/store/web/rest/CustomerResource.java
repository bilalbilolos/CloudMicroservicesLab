...
import fr.ensimag.store.repository.CustomerRepository;
import fr.ensimag.store.service.CustomerService;
import fr.ensimag.store.service.dto.CustomerDTO;
...
/**
 * REST controller for managing {@link fr.ensimag.store.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
