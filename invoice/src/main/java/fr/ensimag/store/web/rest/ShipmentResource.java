...
import fr.ensimag.store.repository.ShipmentRepository;
import fr.ensimag.store.service.ShipmentService;
...
/**
 * REST controller for managing {@link fr.ensimag.store.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
