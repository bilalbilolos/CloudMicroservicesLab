...
```
$ docker image tag gateway bilolos/gateway
$ docker push bilolos/gateway
$ docker image tag invoice bilolos/invoice
$ docker push bilolos/invoice
$ docker image tag notification bilolos/notification
$ docker push bilolos/notification
```
