...
import fr.ensimag.store.service.MailService;
import fr.ensimag.store.service.UserService;
import fr.ensimag.store.service.dto.AdminUserDTO;
import fr.ensimag.store.web.rest.errors.BadRequestAlertException;
import fr.ensimag.store.web.rest.errors.EmailAlreadyUsedException;
import fr.ensimag.store.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
