package fr.ensimag.store.config;

import static org.springframework.security.web.server.util.matcher.ServerWebExchangeMatchers.pathMatchers;

import fr.ensimag.store.security.AuthoritiesConstants;
import fr.ensimag.store.security.jwt.JWTFilter;
import fr.ensimag.store.security.jwt.TokenProvider;
import fr.ensimag.store.web.filter.SpaWebFilter;
