...
import static fr.ensimag.store.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;

import fr.ensimag.store.IntegrationTest;
import fr.ensimag.store.config.Constants;
import fr.ensimag.store.domain.User;
import fr.ensimag.store.repository.AuthorityRepository;
import fr.ensimag.store.repository.UserRepository;
import fr.ensimag.store.security.AuthoritiesConstants;
import fr.ensimag.store.service.UserService;
import fr.ensimag.store.service.dto.AdminUserDTO;
import fr.ensimag.store.service.dto.PasswordChangeDTO;
import fr.ensimag.store.service.dto.UserDTO;
import fr.ensimag.store.web.rest.vm.KeyAndPasswordVM;
import fr.ensimag.store.web.rest.vm.ManagedUserVM;
