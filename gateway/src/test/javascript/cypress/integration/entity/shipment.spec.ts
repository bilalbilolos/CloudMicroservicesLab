...
describe('Shipment e2e test', () => {
  ...
  it('should create an instance of Shipment', () => {
    ...
    cy.get(`[data-cy="date"]`).type('2022-01-28T08:54').invoke('val').should('equal', '2022-01-28T08:54');
    ...
    cy.intercept('GET', '/services/invoice/api/shipments*').as('entitiesRequestAfterCreate');
    cy.visit('/');
    cy.clickOnEntityMenuItem('shipment');
  ...
  it('should delete last instance of Shipment', () => {
    ...
    cy.wait('@entitiesRequest').then(({ request, response }) => {
      ...
      if (startingEntitiesCount > 0) {
        ...
        cy.intercept('GET', '/services/invoice/api/shipments*').as('entitiesRequestAfterDelete');
        cy.visit('/');
        cy.clickOnEntityMenuItem('shipment');
