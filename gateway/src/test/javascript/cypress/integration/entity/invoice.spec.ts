...
describe('Invoice e2e test', () => {
  ...
  it('should create an instance of Invoice', () => {
    ...
    cy.get(`[data-cy="date"]`).type('2022-01-28T12:48').invoke('val').should('equal', '2022-01-28T12:48');
    ...
    cy.get(`[data-cy="paymentDate"]`).type('2022-01-28T06:30').invoke('val').should('equal', '2022-01-28T06:30');
    ...
    cy.intercept('GET', '/services/invoice/api/invoices*').as('entitiesRequestAfterCreate');
    cy.visit('/');
    cy.clickOnEntityMenuItem('invoice');
  ...
  it('should delete last instance of Invoice', () => {
    ...
    cy.wait('@entitiesRequest').then(({ request, response }) => {
      ...
      if (startingEntitiesCount > 0) {
        ...
        cy.intercept('GET', '/services/invoice/api/invoices*').as('entitiesRequestAfterDelete');
        cy.visit('/');
        cy.clickOnEntityMenuItem('invoice');
